@echo off
REM Script batch pour créer un package ZIP portable
REM Alternative simple sans installer

echo ========================================
echo   Creation Package ZIP Portable
echo ========================================
echo.
...
powershell.exe -ExecutionPolicy Bypass -File "create_portable_zip.ps1"
